...
const SoilCard = ({ photo, name, description, page }) => {
    ...
    return (
        <div onClick={() => navigate(`/Soils/${page}`)} className="transition duration-200 ease-in-out hover:shadow-2xl cursor-pointer md:w-[40rem] w-[100%] h-[10rem] flex bg-slate-100 rounded-xl shadow-md">
