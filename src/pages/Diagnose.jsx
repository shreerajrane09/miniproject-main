      ...
      >
        <animated.div align='center' style={fadeLeft}>
          ...
          <p className="text-[16px] text-[#666e75] lg:w-[50rem] w[20rem] mt-4">
            This feature allows users to upload images of their maize crop and fruit images and
        ...
        <div align='center'>
          ...
          >
            ...
            <option value="4">Disease 1 (Fruit)</option>
            <option value="5">Disease 2 (Fruit)</option>
            <option value="6">Disease 3 (Fruit)</option>
